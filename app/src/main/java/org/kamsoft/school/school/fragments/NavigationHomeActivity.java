...
//        classList.add(a);
//
//        a = new Classess(0,true,R.drawable.classroom,"LKJH");
//        classList.add(a);
        ...
        recyclerView3.addItemDecoration(new DividerItemDecoration(rootView.getContext(), LinearLayoutManager.VERTICAL));
